---
title: "The Success of College Basketball Teams can be predicted using several advanced statistics"
subtitle: "A Linear Regression Approach"
author: 
  - Thomas D'Onofrio
...
```{r 3d, echo=FALSE, fig.height=5, fig.width=6, fig.cap= "4D plot showing the relationship between the models response variable, Simple Rating System, and its three predictor variables"}
...
```{r assumplots, echo=FALSE, fig.height=7, fig.cap="Residuals and Fitted Value plots for linear regression model predicting Simple Rating System using a training dataset on college basketball statistics"}
